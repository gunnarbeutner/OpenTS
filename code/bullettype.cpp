...
void BulletTypeClass::Serialize(SaveStreamClass & stream)
{
	...
	SERIALIZE(stream, IsVeryHigh);
	SERIALIZE(stream, IsShadow);
	SERIALIZE(stream, IsArcing);
	SERIALIZE(stream, IsDropping);
	SERIALIZE(stream, IsInvisible);
	SERIALIZE(stream, IsProximityArmed);
	SERIALIZE(stream, IsFueled);
	SERIALIZE(stream, IsFaceless);
	SERIALIZE(stream, IsInaccurate);
	SERIALIZE(stream, IsAntiAircraft);
	SERIALIZE(stream, IsAntiGround);
	SERIALIZE(stream, IsDegenerate);
	SERIALIZE(stream, IsBouncy);
	SERIALIZE(stream, IsAnimPalette);
	SERIALIZE(stream, IsSplits);
	SERIALIZE(stream, IsAntiVehicle);
	SERIALIZE(stream, Cluster);
	SERIALIZE(stream, AirburstWeapon);
	SERIALIZE(stream, Elasticity);
	SERIALIZE(stream, Acceleration);
	SERIALIZE(stream, Color);
	SERIALIZE(stream, Trailer);
	SERIALIZE(stream, ROT);
	SERIALIZE(stream, RetargetAccuracy);
	SERIALIZE(stream, Arming);
	SERIALIZE(stream, AnimLow);
	SERIALIZE(stream, AnimHigh);
	SERIALIZE(stream, AnimRate);
	SERIALIZE(stream, Tumble);
}

...
void UIGameOptionsView::On_Action(Rml::Event & event, Rml::VariantList const & arguments)
{
	...
	if (name == "controls") {
		...
		intent.Identity = (int)(event.GetParameter<float>("value", (float)Hub.Speed) + 0.5f);
	} else {
		return;
	}

...
class UILobbyView : public UILobbyViewBase
{
	...
	private:
		...
		void On_Action(Rml::Event & event, Rml::VariantList const & arguments) override;
...
void UILobbyView::On_Action(Rml::Event & event, Rml::VariantList const & arguments)
{
	if (arguments.size() < 2) {
		return;
	}
...
void UINetMessageBoxView::On_Action(Rml::Event &, Rml::VariantList const & arguments)
{
	if (arguments.size() < 2) {
		return;
	}
...
void UIMapSelectView::On_Action(Rml::Event & event, Rml::VariantList const & arguments)
{
	if (arguments.size() < 2) {
		return;
	}

...
// Whether a context is applying its data views. What a control reports from inside that is
// the model's own value reaching it, not an act of the player's.
bool UI_Views_Are_Updating(void);
